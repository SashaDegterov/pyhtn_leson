        ...
        if i.type==MOUSEBUTTONDOWN:
            if i.button==1:
                ...
                if 160<i.pos[0]<160+70 and 200<i.pos[1]<200+30:
                    ...
                    tanksik=image.load("tank2.png")
                    tank_skeil_10=transform.scale(tanksik,(100,100))
                    win.blit(tank_skeil_10,(130,100))
                    #if tank=image.load("tank.png")
                        #tank_skeil=transform.scale(tank,(50,50))
                        #win.blit(tank_skeil,(10,100))
                    tanksiki=image.load("tank3.png")
                    tank_skeil_1=transform.scale(tanksiki,(100,100))
                    win.blit(tank_skeil_1,(250,100))
                    display.flip()
                    display.update()